...
def init_db():
    ...
    c.execute("INSERT INTO system_config VALUES (2, 'maintenance_mode', 'false')")
    c.execute(f"INSERT INTO system_config VALUES (3, 'system_flag', '{FLAG}')")
    ...
    def do_POST(self):
        if self.path == '/login':
            ...
            try:
                ...
                # Kita perlu me-render ulang dashboard untuk menampilkan hasil
                # Ambil data user yang sedang login untuk header dashboard
...
<body>
    ...
    <div class="container">
        ...
        <details>
            ...
            <div class="hint-text">
                > HINT 1: The search feature directly queries the database. If you can manipulate the query, you might retrieve data from other tables like 'system_config'.<br>
                > HINT 2: The SQL UNION operator combines the result-set of two or more SELECT statements. Remember, the number of columns in both queries must match.
            </div>
        </details>
    </div>
</body>
...
if __name__ == '__main__':
    ...
    print("=" * 50)
    print("CTFdpk Arena - Topic 4, Level 2 (UNION Injection) Started!")
