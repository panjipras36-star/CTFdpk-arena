...
FLAG = "FLAG{3nv_f1l3_l34k_1s_d4ng3r0us}"
...
# Internal Secret
INTERNAL_FLAG=FLAG{3nv_f1l3_l34k_1s_d4ng3r0us}
"""
...
<head>
    ...
    <title>CTFdpk Arena - Topic 2: Level 3</title>
    <style>
    ...
    <div class="container">
        <div class="challenge-card">
            <div class="challenge-header">
                <div><h2 class="challenge-title">Topic 2: Information Disclosure - Level 3</h2><div class="challenge-meta">Category: Misconfiguration | Difficulty: Medium</div></div>
            </div>
            <div class="description">
                <p>You are getting good at finding public files, agent. Now let's look for <strong>hidden</strong> files.</p>
                <p>Modern web applications use a specific configuration file to store sensitive data like database passwords, API keys, and secret flags. This file is usually hidden from standard directory listings because its name starts with a dot.</p>
                <p>The server here is misconfigured and allows direct access to this file if you know its name.</p>
                <p><strong>Your Objective:</strong> Find the hidden configuration file and extract the flag. Format: <code>FLAG{...}</code></p>
            </div>
            <div class="hints-section">
                <h3 style="color: var(--accent); margin-bottom: 1rem;">Need Help? (Hints)</h3>
                <details><summary>Hint 1</summary><div class="hint-content">The file is widely used in Node.js, Python, and PHP projects to store "Environment Variables".</div></details>
                <details><summary>Hint 2</summary><div class="hint-content">The filename is very short. It consists of a dot followed by three letters. Try accessing it directly at the root of the server.</div></details>
            </div>
        ...
        if self.path == '/submit':
            ...
            try:
                ...
                if submitted_flag == FLAG:
                    response = {"success": True, "message": "Level 3 Cleared! You found the .env leak."}
                else:
...
if __name__ == '__main__':
    ...
    print("=" * 50)
    print("CTFdpk Arena - Topic 2, Level 3 Started!")
