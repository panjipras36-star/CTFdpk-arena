...
<body>
    ...
    <div class="container">
        <div class="challenge-card">
            <div class="challenge-header">
                <div>
                    <h2 class="challenge-title">Topic 1: View Source - Level 1</h2>
                    <div class="challenge-meta">Category: Web Exploitation | Difficulty: Easy</div>
                </div>
            </div>
            ...
            <div class="hints-section">
                ...
                <details>
                    ...
                    <div class="hint-content">The flag is not visible on the rendered page. You need to look at the raw HTML code sent by the server.</div>
                </details>
                <details>
                    <summary>Hint 2</summary>
                    <div class="hint-content">Right-click anywhere on the page and select "View Page Source", or press <code>Ctrl+U</code> (Windows/Linux) / <code>Cmd+U</code> (Mac).</div>
                </details>
                <details>
                    <summary>Hint 3</summary>
                    <div class="hint-content">Look for HTML comments. They are used to hide text in the source code and look like this: <code>&lt;!-- text --&gt;</code></div>
                </details>
            </div>
    ...
    <!-- 
        ...
        Admin backup password: hunter2
        System check: All green.
        FLAG{1nsp3ct_3l3m3nt_b4s1cs}
    -->
</body>
</html>
"""
