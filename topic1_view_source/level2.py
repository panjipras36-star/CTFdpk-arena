...
<head>
    ...
    <meta name="description" content="CTFdpk Arena Level 2">
    <meta name="author" content="DarkNet Corp">
    <meta name="ctf-internal-id" content="849201">
    <title>CTFdpk Arena - Topic 1: Level 2</title>
    <style>
        :root {
            ...
            /* TODO: Remove debug token before production deployment: FLAG{m3t4_d4t4_l34k_1s_r34l} */
        }
        ...
        if self.path == '/submit':
            ...
            try:
                ...
                if submitted_flag == FLAG:
                    response = {"success": True, "message": "Level 2 Cleared! Great eye for detail."}
                else:
                    response = {"success": False, "message": "Incorrect flag. Keep digging!"}
                self.send_response(200)
